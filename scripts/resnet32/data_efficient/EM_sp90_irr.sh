...
SAVE_FOLDER=${7:-"checkpoints/resnet32/data_sparse/mutate_irr/${DATASET}/remove_${REMOVE_N}/"}
...
REMARK=${13:-"irr_0.9_mut_RM_${REMOVE_N}"}
LOG_NAME=${14:-"irr_0.9_mut_RM_${REMOVE_N}_${RM_EPOCH}"}
PKL_NAME=${23:-"irr_0.9_mut_RM_${REMOVE_N}_${RM_EPOCH}"}
