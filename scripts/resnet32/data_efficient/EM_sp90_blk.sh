...
SAVE_FOLDER=${7:-"checkpoints/resnet32/data_sparse/mutate_blk/${DATASET}/remove_${REMOVE_N}/"}
...
REMARK=${13:-"blk_0.9_mut_RM_${REMOVE_N}"}
LOG_NAME=${14:-"blk_0.9_mut_RM_${REMOVE_N}_${RM_EPOCH}"}
PKL_NAME=${23:-"blk_0.9_mut_RM_${REMOVE_N}_${RM_EPOCH}"}
