...
SAVE_FOLDER=${7:-"checkpoints/resnet32/data_sparse/mutate_pattern/${DATASET}/remove_${REMOVE_N}/"}
...
REMARK=${13:-"pat_0.9_mut_RM_${REMOVE_N}"}
LOG_NAME=${14:-"pat_0.9_mut_RM_${REMOVE_N}_${RM_EPOCH}"}
PKL_NAME=${23:-"pat_0.9_mut_RM_${REMOVE_N}_${RM_EPOCH}"}
